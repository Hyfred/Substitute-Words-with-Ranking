...
def eval(pred, gold):
    ...
    for idx, v in list(goldjson.items())[:]:
    ...
    p_detection = detection_tp / detection_pred if detection_tp > 0 else 0
    r_detection = detection_tp / detection_gold if detection_gold > 0 else 0
    r_detection_type = []
    for typeid in range(2):
